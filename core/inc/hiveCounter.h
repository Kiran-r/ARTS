...
#define LASTCOUNTER lastCounter
    ...
    enum hiveCounterType { 
        ...
        fireEdt, handleReadyEdt, finishCounter, stealAttempt, stealCounter, dequeStealCounter,
        dequePushCounterOn, dequePopCounterOn,
        guidAllocCounterOn, guidAssociateCounterOn, guidLookupCounterOn,
        edtCreateCounterOn, eventCreateCounterOn, dbCreateCounterOn, localDbAcquireOn,
        signalEventCounterOn, signalEdtCounterOn, addDependenceOn,
        sendQueuePushOn, sendQueuePullOn,
        mallocMemoryOn, callocMemoryOn, freeMemoryOn,
        dequePushCounter, dequePopCounter,    
        guidAllocCounter, guidAssociateCounter, guidLookupCounter,
        edtCreateCounter, eventCreateCounter, dbCreateCounter, localDbAcquire, edtDelay, acquireDelay,
        signalEventCounter, signalEdtCounter, addDependence,
        sendQueuePush, sendQueuePull,
        mallocMemory, callocMemory, freeMemory,
        pktReceive, pktSend, pktProc,
        edtMoveProc, eventMoveProc, dbMoveProc, 
        roundTripMemoryMove, roundTripMemoryMoveProc,
        roundTripDbAcquire, roundTripDbAcquireProc,
        remoteEdtSigMsg, remoteEventSatMsg, remoteAddDepMsg,         
        remoteTemplateReqMsg, remoteTemplateSendMsg, 
        remoteInvalidateDbMsg, remoteInvalidateRequestMsg, remoteInvalidateDbPingMsg, remoteDbSendMsg,
        networkSendQueueSitting,   
        totalNetworkSendTime, goodSendAttempts, badSendAttempts,
        totalNetworkRecvTime, goodRecvAttempts, badRecvAttempts,
        remoteStealRequestsSent, remoteStealRequestsRecv, 
        remoteEdtsSent, remoteEdtReceived,
        ooSigEdt, ooEventSat, ooEventSatSlot,
        ooAddDep, ooReadyEdt, ooRemoteDb,
        remoteDbLockMsg, remoteDbUnlockMsg, remoteDbLockAllDbsMsg, delayOverlap, dbSend, edtFree,
        emptyTime, mapperTime, reducerTime,
        lastCounter
    };
