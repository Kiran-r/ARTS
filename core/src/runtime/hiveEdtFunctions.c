...
//        hiveRemoteMemoryMoveNoFree(rank, bufferGuid, buffer, size, HIVE_REMOTE_BUFFER_SEND);
        hiveRemoteMemoryMove(rank, bufferGuid, buffer, size, HIVE_REMOTE_BUFFER_SEND, hiveFree);
    }
    return ret;
}
