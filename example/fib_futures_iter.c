...
//
//	if (n < 2) {
//		artsSignalEdt(guid, n, slot, DB_MODE_SINGLE_VALUE);
//	}
//
//	int fib = 1;
//	int prevFib = 1;
...
//    artsSignalEdt(paramv[0], x+y, paramv[1], DB_MODE_SINGLE_VALUE);
//}
//
//
...
//    if(num < 2)
//        artsSignalEdt(guid, num, slot, DB_MODE_SINGLE_VALUE);
//    else
//    {
//        artsGuid_t joinGuid = hiveEdtCreate(fibJoin, 0, paramc-1, paramv, 2);
//        
//        // Test
...
//        artsGuid_t doneGuid = hiveEdtCreate(fibDone, 0, 1, (uint64_t*)&num, 1);
//
//        { // Iterative version
...
//        artsGuid_t guid = hiveEdtCreate(fibIterativeFut, 0, 3, args, 0); // OPTIONAL future iterative
//        }
///*
//
//        { // Recursive version
